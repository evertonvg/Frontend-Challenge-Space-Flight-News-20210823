<template>
    <main>
        <header>
            <div class="flex items-center justify-end mx-auto max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl py-2 ">
                ...
                <div class="relative cursor-pointer">
                    <div  data-name="order" class="rounded-md py-1.5 pl-2 pr-3 border-solid border-blueblack border-2 w-32 md:w-36">
                    ...
                    <div v-show="showOrderOpts" class="absolute left-0 top-full mt-2 flex flex-col w-full">
            ...
            <div class="flex border-b-2 border-blueblack border-solid py-10 flex-col items-center justify-center mx-auto max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
                <div class="flex border-2 border-blueblack border-solid rounded-full p-8">
                    <rocket-launch fillColor="#302E53" :size="60"/>
                </div>
...
.select-option{
    @apply py-1.5 pl-2 pr-3 border-solid border-blueblack border-2 w-full;
